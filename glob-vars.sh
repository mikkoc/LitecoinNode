...
SCRIPT_DL_URL="https://raw.githubusercontent.com/litecoin-foundation/LitecoinNode/master" #the download location of the script files
WEBSITE_DL_URL="https://raw.githubusercontent.com/litecoin-foundation/LitecoinNode/master/shared/www" #the download location of the status page website files
